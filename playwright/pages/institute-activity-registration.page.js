...
exports.InstituteActivityIntentPage = class InstituteActivityIntentPage {
  constructor(page) {
    this.page = page;
    ...
    this.organizationNameField = page.locator( 'input[id^="institution-goonj-activities-initiator-organization-name-"]')
    this.locationAreaOfActivityField = page.locator('input[id^="institution-goonj-activities-where-do-you-wish-to-organise-the-activity-"]');
    this.cityField = page.locator('input[id^="institution-goonj-activities-city-"]');
    // this.stateSelect = page.locator('af-field[name="Collection_Camp_Intent_Details.State"] .select2-container');
    this.pinCodeField = page.locator('af-field[name="Institution_Goonj_Activities.Postal_Code"] input[type="text"]');
    this.startDateInput = page.locator('af-field[name="Institution_Goonj_Activities.Start_Date"] input[aria-label="Select Date"]'); //Date input
    this.startTimeInput = page.locator('af-field[name="Institution_Goonj_Activities.Start_Date"] input[aria-label="Time"]');
    this.endDateInput = page.locator('af-field[name="Institution_Goonj_Activities.End_Date"] input[aria-label="Select Date"]'); //Date input
    this.endTimeInput = page.locator('af-field[name="Institution_Goonj_Activities.End_Date"] input[aria-label="Time"]');
    this.firstNameField = page.locator('input[id^="first-name-10"]');
    this.lastNameField = page.locator('input[id^="last-name-11"]');
    this.contactEmailField = page.locator('input[id^="email-12"]');
