...
{if $result eq true}
  ...
  {/if}
  {if $task eq 'cancel'}
  <div class="crm-group cancel-group">
    <div class="header-dark">
      {ts}Success{/ts}
    </div>
    <div class="crm-section no-label cancel_details-section">
      <div class="content">Your recurring contribution has been successfully cancelled.</div>
      <div class="clear"></div>
    </div>
  </div>
  {/if}
