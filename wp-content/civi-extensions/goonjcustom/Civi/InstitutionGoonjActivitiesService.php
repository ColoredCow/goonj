  ...
  public static function institutionGoonjActivitiesTabset($tabsetName, &$tabs, $context) {
    ...
    $tabConfigs = [
      'activities' => [
        ...
        'permissions' => ['goonj_chapter_admin', 'urbanops', 'urban_ops_admin', 's2s_ho_team', 'project_team_ho', 'project_team_chapter', 'njpc_ho_team', 'sanjha_team'],
      ],
      'edit' => [
        'title' => ts('Edit'),
      ...
      'monetaryContribution' => [
        ...
        'template' => 'CRM/Goonjcustom/Tabs/InstitutionGoonjActivities/MonetaryContribution.tpl',
      ...
      //   'directive' => 'afsearch-monetary-contribution-for-urban-ops',
       //   'template' => 'CRM/Goonjcustom/Tabs/InstitutionGoonjActivities/MonetaryContributionForUrbanOps.tpl',
