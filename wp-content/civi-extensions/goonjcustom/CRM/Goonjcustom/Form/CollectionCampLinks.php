  ...
  public function generateLinks($contactId):void {
    ...
    $links = [
        [
          ...
          'url' => self::createUrl('/camp-vehicle-dispatch-form', "Camp_Vehicle_Dispatch.Collection_Camp_Intent_Id={$this->_collectionCampId}&Camp_Vehicle_Dispatch.To_which_PU_Center_material_is_being_sent={$this->_processingCenterId}", $contactId),
        ],
        [
          'label' => 'Camp Outcome',
          'url' => self::createUrl('/camp-outcome-form', "Eck_Collection_Camp1={$this->_collectionCampId}", $contactId),
        ],
    ];
