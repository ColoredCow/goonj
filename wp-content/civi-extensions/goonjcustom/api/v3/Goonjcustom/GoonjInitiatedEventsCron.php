 ...
 * @return void
 */
function _civicrm_api3_goonjcustom_goonj_initiated_events_cron_spec(&$spec) {
 ...
 */
function civicrm_api3_goonjcustom_goonj_initiated_events_cron($params) {
  $returnValues = [];
  $today = new DateTimeImmutable();
  $endOfDay = $today->setTime(23, 59, 59)->format('Y-m-d H:i:s');
  $events = Event::get(TRUE)
    ->addSelect('Goonj_Events.Venue', 'Goonj_Events.Goonj_Coordinating_POC_Main_', 'Goonj_Events.Goonj_Coordinating_POC', 'start_date', 'end_date', 'Goonj_Events_Outcome.Outcome_Email_Sent')
  ...
  return civicrm_api3_create_success($returnValues, $params, 'Goonjcustom', 'goonj_initiated_events_cron');
}
