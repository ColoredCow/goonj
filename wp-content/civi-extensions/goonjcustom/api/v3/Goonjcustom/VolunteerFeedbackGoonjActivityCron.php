...
function civicrm_api3_goonjcustom_volunteer_feedback_goonj_activity_cron($params) {
  ...
  $collectionCamps = EckEntity::get('Collection_Camp', TRUE)
    ->addSelect('Goonj_Activities.End_Date', 'Logistics_Coordination.Feedback_Email_Sent', 'Collection_Camp_Core_Details.Contact_Id', 'Goonj_Activities.Where_do_you_wish_to_organise_the_activity_')
