 ...
 */
class CRM_AwsSes_Upgrader_Base {

  /**
   * @var CRM_AwsSes_Upgrader_Base
   */
   ...
   *
   * ```
   * CRM_AwsSes_Upgrader_Base::_queueAdapter($ctx, 'methodName', 'arg1', 'arg2');
   * ```
   */
  ...
  /**
   * CRM_AwsSes_Upgrader_Base constructor.
   *
   * @param $extensionName
   * @param $extensionDir
   */
