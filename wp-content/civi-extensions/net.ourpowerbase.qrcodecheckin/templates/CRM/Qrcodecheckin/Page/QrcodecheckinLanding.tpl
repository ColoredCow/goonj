...
{if $has_permission == FALSE}
  ...
  <p>{ts domain="net.ourpowerbase.qrcodecheckin"}Congratulations! Your QR Code for checkin works. Please present your QR code at registration desk when you arrive.{/ts}</p>
{else}
