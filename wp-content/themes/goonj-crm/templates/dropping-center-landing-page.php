<?php
/*
Template Name: dropping center Landing Page
*/
?>

<div class="text-center ml-30 mr-30">
	<h2 class="font-sans fz-20 fw-400 mb-6">Goonj Dropping</h2>
	...
	<div class="login-submit w-100p mt-36">
		<a class="button button-primary d-flex justify-content-center align-items-center text-decoration-none border-radius font-family" href="<?php echo esc_url(get_permalink(get_page_by_path('dropping-center'))); ?>">Continue</a>
	</div>
</div>
